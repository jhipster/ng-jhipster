...
describe('Base64 service test', function () {
    describe('Base64 Service Test', function () {
        beforeEach(function () {
        ...
        it('should encode the text', inject([Base64], function (service) {
            expect(service.encode('Hello Jhipster')).toBe('SGVsbG8gSmhpcHN0ZXI=');
        }));
        it('should decode the encoded text', inject([Base64], function (service) {
